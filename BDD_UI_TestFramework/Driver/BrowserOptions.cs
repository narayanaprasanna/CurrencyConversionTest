...
namespace BDD_UI_TestFramework.Browser
{
    ...
    public class BrowserOptions
    {
        ...
        /// <summary>
        ///  Provide the download path for the files you want to download on the location
        /// </summary>
        ...
        public bool EnableCosoleLogging { get; set; }
        ...
        public string Enviornment { get; internal set; }
        ...
        public virtual ChromeOptions ToChrome()
        {
            ...
            if(this.Height.HasValue && this.Width.HasValue)
            {
                ...
                options.AddArgument("--window-size="+height+","+width);
            }
